...
<body>
<header class="Hui-header cl"> <a class="Hui-logo l" title="H-ui.admin v2.3" href="/">享买开放平台</a> <a class="Hui-logo-m l" href="/" title="H-ui.admin">H-ui</a> <span class="Hui-subtitle l">V1.0</span>
	...
	<ul class="Hui-userbar">
		...
		<li id="Hui-skin" class="dropDown right dropDown_hover"><a href="javascript:" title="换肤"><i class="Hui-iconfont"
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-channel">
			<dt><i class="Hui-iconfont">&#xe62d;</i> 开发者中心<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
		...
		<dl id="menu-system">
			...
			<dd>
				<ul>
					...
					<li><a _href="${pageContext.request.contextPath}/artice/forwordArtice.dhtml" href="javascript:void(0)">系统日志</a></li>
				</ul>
			</dd>
		</dl>
			<dl id="menu-essay">
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active"><span title="我的桌面" data-href="welcome.dhtml">我的桌面</span><em></em></li>
			</ul>
		</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="welcome.dhtml"></iframe>
		</div>
	</div>
</section>
