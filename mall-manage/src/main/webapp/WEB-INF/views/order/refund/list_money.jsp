...
<script type="text/javascript">
  var targetTable;
  var url = "${pageContext.request.contextPath}/order/getRefundMoney.dhtml";
  ...
  function searchOrder(){
    ...
    url = '${pageContext.request.contextPath}'+'/order/getRefundMoneyByCondition.dhtml?findBy='+findBy +'&detail='+detail+'&datemin='+datemin+'&datemax='+datemax;
