 ...
 */
@Controller
@RequestMapping(value = ManageURIConstant.ProductType.REQUEST_MAPPING)
public class ProductTypeController extends BaseController {
    ...
    @RequestMapping(value = ManageURIConstant.ProductType.REQUEST_MAPPING_FITST_LEVEL, produces = {"application/json"})
    @ResponseBody
    ...
    @RequestMapping(value = ManageURIConstant.ProductType.REQUEST_MAPPING_CHILDREN_LEVEL, produces = {"application/json"})
    @ResponseBody
    ...
    @RequestMapping(value = ManageURIConstant.ProductType.REQUEST_MAPPING_FIND_BY_ID, produces = {"application/json"})
    @ResponseBody
