...
public class ExpressController  extends BaseController{
	...
	public String getAllType(@NotEmpty @PathVariable("id") String id,@NotEmpty @PathVariable("order") String order) {
    	...
    	try {
/*			resultDTO = restTemplate.postForEntity(this.buildBizAppURI(APPURIConstant.Express.REQUEST_MAPPING, APPURIConstant.Express.REQUEST_MAPPING_FIND),expressDTO, Response.class);
*/	
