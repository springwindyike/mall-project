...
public interface APPURIConstant {
    ...
    interface ProductType{
        ...
        String REQUEST_MAPPING_DEL_BY_ID="/delById";
    ...
    interface Brand {
        ...
        String REQUEST_MAPPING_ALL_BRAND_LIST = "/allBrandList";
    ...
    interface Order {
        ...
        String REQUEST_MAPPING_REFUND_CONFIRM = "/refundConfirm/{refundId}";
    }
    //支付
    interface AliPay {
        //支付宝
