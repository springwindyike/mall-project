                    ...
                    w, x = ["shiftKey", "altKey", "ctrlKey"], y = function (a, b) {
                        ...
                        if (g && (d.p.data = [], d.p._index = {}, d.p.localReader.id = h), d.p.reccount = 0, $.isXMLDoc(a)) {
                            ...
                            if (Q > 0 && d.p.page <= 0 && (d.p.page = 1), O && Q) {
                                e && (T *= e + 1);
                                var
                                    V, W = $.isFunction(d.p.afterInsertRow), X = !1, Y = $("#" + $.jgrid.jqID(d.p.id) + " tbody:first"), Z = B ? k(l, "rownumBox", !1, "jqgrid-rownum") : "", _ = z ? k(l, "multiBox", !1, "cbox") : "";
                        ...
                        if ($.isArray(d.p.data)) {
                            ...
                            var
                                v = q.select(), w = parseInt(d.p.rowNum, 10), x = v.length, y = parseInt(d.p.page, 10), z = Math.ceil(x / w), A = {};
    ...
    a.extend(a.jgrid, {
        showModal: function (a) {
            ...
            if (c = a.extend({
                    ...
                    c.focusField || c.focusField ? 0 : !1, a.fn.jqm && c.jqm === !0)c.jqM ? a(b).attr("aria-hidden", "false").jqm(c).jqmShow() : a(b).attr("aria-hidden", "false").jqmShow(); else if ("" !== c.gbox && (a(".jqgrid-overlay:first", c.gbox).show(), a(b).data("gbox", c.gbox)), a(b).show().attr("aria-hidden", "false"), c.focusField >= 0)try {
    ...
    a.jgrid.extend({
        editGridRow: function (c, d) {
            ...
            return d = a.extend(!0, {
                        ...
                        if (c.length) {
                            ...
                            a.each(r.p.colModel, function () {
                                if (this.name === e && this.editoptions && a.isFunction(this.editoptions.custom_value)) {
                                    try {
                                        if (t[e] = this.editoptions.custom_value.call(r, a("#" + a.jgrid.jqID(e), z), "get"), void
                                                0 === t[e])throw"e1"
                                    } catch (c) {
                ...
                f(c, d, e, f) {
                    var
                        h, i, j, k, l, m, n, o = 0, p = [], q = !1, s = "<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>", t = "";
                    for (n = 1; f >= n; n++)t += s;
                    if ("_empty" !== c && (q = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function (n) {
                            if (h = this.name, i = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, l = i ? "style='display:none'" : "", "cb" !== h && "subgrid" !== h && this.editable === !0 && "rn" !== h) {
                                ...
                                if ("_empty" === c && u.defaultValue && (k = a.isFunction(u.defaultValue) ? u.defaultValue.call(r) : u.defaultValue), this.edittype || (this.edittype = "text"), r.p.autoencode && (k = a.jgrid.htmlDecode(k)), m = a.jgrid.createEl.call(r, this.edittype, u, k, !1, a.extend({}, a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), "select" === this.edittype && (k = a(m).val(), "select-multiple" === a(m).get(0).type && k && (k = k.join(","))), "checkbox" === this.edittype && (k = a(m).is(":checked") ? a(m).val() : a(m).attr("offval")), (b[r.p.id].checkOnSubmit || b[r.p.id].checkOnUpdate) && (b[r.p.id]._savedData[h] = k), a(m).addClass("FormElement"), a.inArray(this.edittype, ["text", "textarea", "password", "select"]) > -1 && a(m).addClass(g.inputClass), E)a(K).find("#" + h).replaceWith(m); else {
                                    ...
                                    0 === j.length && (j = a("<tr " + l + " rowpos='" + w + "'></tr>").addClass("FormData").attr("id", "tr_" + h), a(j).append(t), a(e).append(j), j[0].rp = w), a("td:eq(" + (y - 2) + ")", j[0]).html("<label for='" + h + "'>" + (void
                                            0 === v.label ? d.p.colNames[n] : v.label) + "</label>"), a("td:eq(" + (y - 1) + ")", j[0]).append(v.elmprefix).append(m).append(v.elmsuffix)
                                }
                ...
                k() {
                    var
                        c, e, f, g, k, l, m, n = [!0, "", ""], o = {}, p = r.p.prmNames, q = a(r).triggerHandler("jqGridAddEditBeforeCheckValues", [a(x), v]);
                    q && "object" == typeof
                        q && (t = q), a.isFunction(b[r.p.id].beforeCheckValues) && (q = b[r.p.id].beforeCheckValues.call(r, t, a(x), v), q && "object" == typeof
                        q && (t = q));
                    for (g
                        in
                        t)if (t.hasOwnProperty(g) && (n = a.jgrid.checkValues.call(r, t[g], g), n[0] === !1))break;
                    if (j(), n[0] && (o = a(r).triggerHandler("jqGridAddEditClickSubmit", [b[r.p.id], t, v]), void
                        ...
                        if (b[r.p.id].processing = !0, a("#sData", z + "_2").addClass(h.active), m = b[r.p.id].url || a(r).jqGrid("getGridParam", "editurl"), f = p.oper, e = "clientArray" === m ? r.p.keyName : p.id, t[f] = "_empty" === a.trim(t[r.p.id + "_id"]) ? p.addoper : p.editoper, t[f] !== p.addoper ? t[e] = t[r.p.id + "_id"] : void
                                0 === t[e] && (t[e] = t[r.p.id + "_id"]), delete
                                t[r.p.id + "_id"], t = a.extend(t, b[r.p.id].editData, o), r.p.treeGrid === !0) {
                            if (t[f] === p.addoper) {
                            ...
                            for (l
                                in
                                r.p.treeReader)if (r.p.treeReader.hasOwnProperty(l)) {
                                var
                                    u = r.p.treeReader[l];
                            ...
                            y = a.extend({
                                ...
                                complete: function (g, j) {
                                    ...
                                    if (a("#sData", z + "_2").removeClass(h.active), t[e] = r.p.idPrefix + t[e], g.status >= 300 && 304 !== g.status ? (n[0] = !1, n[1] = a(r).triggerHandler("jqGridAddEditErrorTextFormat", [g, v]), n[1] = a.isFunction(b[r.p.id].errorTextFormat) ? b[r.p.id].errorTextFormat.call(r, g, v) : j + " Status: '" + g.statusText + "'. Error code: " + g.status) : (n = a(r).triggerHandler("jqGridAddEditAfterSubmit", [g, t, v]), void
                                            0 === n && (n = [!0, "", ""]), n[0] && a.isFunction(b[r.p.id].afterSubmit) && (n = b[r.p.id].afterSubmit.call(r, g, t, v))), n[0] === !1)a(".FormError", x).html(n[1]), a(".FormError", x).show(); else if (r.p.autoencode && a.each(t, function (b, c) {
                                        ...
                                        }, 500)), (b[r.p.id].checkOnSubmit || b[r.p.id].checkOnUpdate) && (a(x).data("disabled", !1), "_empty" !== b[r.p.id]._savedData[r.p.id + "_id"]))for (l
                                        in
                ...
                n() {
                    var
                        b;
                    if ("_empty" !== c && void
                            0 !== r.p.savedRow && r.p.savedRow.length > 0 && a.isFunction(a.fn.jqGrid.restoreRow))for (b = 0; b < r.p.savedRow.length; b++)if (r.p.savedRow[b].id === c) {
                ...
                p() {
                    var
                        b = a(r).jqGrid("getDataIDs"), c = a("#id_g", z).val(), d = a.inArray(c, b);
                    return [d, b]
                }
                ...
                if (r.grid && c) {
                    var
                        s, t, u, v, w = r.p.id, x = "FrmGrid_" + w, y = "TblGrid_" + w, z = "#" + a.jgrid.jqID(y), A = {
                            themodal: "editmod" + w,
                            modalhead: "edithd" + w,
                            modalcontent: "editcnt" + w,
                            scrollelm: x
                        }, B = !0, C = 1, D = 0, E = "string" == typeof
                                b[r.p.id].template && b[r.p.id].template.length > 0, F = a.jgrid.getRegional(this, "errors");
                    ...
                    var
                        H, I = isNaN(b[a(this)[0].p.id].dataheight) ? b[a(this)[0].p.id].dataheight : b[a(this)[0].p.id].dataheight + "px", J = isNaN(b[a(this)[0].p.id].datawidth) ? b[a(this)[0].p.id].datawidth : b[a(this)[0].p.id].datawidth + "px", K = a("<form name='FormPost' id='" + x + "' class='FormGrid' onSubmit='return false;' style='width:" + J + ";height:" + I + ";'></form>").data("disabled", !1);
                    if (E ? (H = q(b[a(this)[0].p.id].template), s = z) : (H = a("<table id='" + y + "' class='EditTable ui-common-table'><tbody></tbody></table>"), s = z + "_2"), x = "#" + a.jgrid.jqID(x), a(K).append("<div class='FormError " + h.error + "' style='display:none;'></div>"), a(K).append("<div class='tinfo topinfo'>" + b[r.p.id].topinfo + "</div>"), a(r.p.colModel).each(function () {
                        ...
                        }), a(K).append(H), B = a(r).triggerHandler("jqGridAddEditBeforeInitData", [K, v]), void
                            0 === B && (B = !0), B && a.isFunction(b[r.p.id].beforeInitData) && (B = b[r.p.id].beforeInitData.call(r, K, v)), B !== !1) {
                        n(), f(c, r, H, C);
                        var
                        ...
                        a(r).triggerHandler("jqGridAddEditInitializeForm", [a(x), v]), a.isFunction(b[r.p.id].onInitializeForm) && b[r.p.id].onInitializeForm.call(r, a(x), v), "_empty" !== c && b[r.p.id].viewPagerButtons ? a("#pData,#nData", s).show() : a("#pData,#nData", s).hide(), a(r).triggerHandler("jqGridAddEditBeforeShowForm", [a(x), v]), a.isFunction(b[r.p.id].beforeShowForm) && b[r.p.id].beforeShowForm.call(r, a(x), v), a("#" + a.jgrid.jqID(A.themodal)).data("onClose", b[r.p.id].onClose), a.jgrid.viewModal("#" + a.jgrid.jqID(A.themodal), {
                            ...
                            onHide: function (b) {
                                var
                                    c = a("#editmod" + w)[0].style.height, d = a("#editmod" + w)[0].style.width;
                            ...
                            if (b[0] = parseInt(b[0], 10), -1 !== b[0] && b[1][b[0] + 1]) {
                                ...
                                var
                                    c;
                                if (a.isFunction(d.onclickPgButtons) && (c = d.onclickPgButtons.call(r, "next", a(x), b[1][b[0]]), void
                                        0 !== c && c === !1))return !1;
                            ...
                            if (-1 !== b[0] && b[1][b[0] - 1]) {
                                ...
                                var
                                    c;
                                if (a.isFunction(d.onclickPgButtons) && (c = d.onclickPgButtons.call(r, "prev", a(x), b[1][b[0]]), void
                                        0 !== c && c === !1))return !1;
                                if (a("#" + a.jgrid.jqID(b[1][b[0] - 1])).hasClass(h.disabled))return !1;
            ...
            return this.each(function () {
                var
                    j = this, k = j.p.styleUI, l = (a.jgrid.styleUI[k].navigator, a.jgrid.styleUI[k].filter), m = a.jgrid.styleUI[k].common, n = "form_menu_" + a.jgrid.randId(), o = "<button class='dropdownmenu " + m.button + "' value='" + n + "'>Actions</button>";
                ...
                var
                    p = {
                        ...
                        var
                            b, k, o = a(".ui-jqgrid-view").css("font-size") || "11px", q = a('<ul id="' + n + '" class="ui-nav-menu modal-content" role="menu" tabindex="0" style="display:none;font-size:' + o + '"></ul>');
                ...
                q(), a(".dropdownmenu").on("click", function () {
                    var
                        b = a(this).offset(), c = b.left, d = parseInt(b.top), e = a(this).val();
                    a("#" + e).show().css({top: d - (a("#" + e).height() + 10) + "px", left: c + "px"})
        ...
        filterToolbar: function (b) {
            ...
            return b = a.extend({
                ...
                if (!d.p.filterToolbar) {
                    ...
                    var
                        e, f = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].filter, g = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].common, h = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].base, i = function () {
                            var
                                c, e, f, g = {}, h = 0, i = {};
                            ...
                            for (var
                                     j, k, l = a(".ui-jqgrid-view").css("font-size") || "11px", m = '<ul id="sopt_menu" class="ui-search-menu modal-content" role="menu" tabindex="0" style="font-size:' + l + ";left:" + e + "px;top:" + h + 'px;">', n = a(c).attr("soper"), o = [], p = 0, q = a(c).attr("colname"), r = d.p.colModel.length; r > p && d.p.colModel[p].name !== q;)p++;
                            var
                    ...
                    a.each(d.p.colModel, function (c) {
                        var
                            g, j, k, l, n, o, p, q = this, r = "", s = "=", t = a("<th role='columnheader' class='" + h.headerBox + " ui-th-" + d.p.direction + "' id='gsh_" + d.p.id + "_" + q.name + "' ></th>"), u = a("<div></div>"), v = a("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper' headers=''></td><td class='ui-search-input' headers=''></td><td class='ui-search-clear' headers=''></td></tr></table>");
                        if (this.hidden === !0 && a(t).css("display", "none"), this.search = this.search === !1 ? !1 : !0, void
                            ...
                            if (b.searchOperators) {
                                for (j = g.sopt ? g.sopt[0] : "select" === q.stype ? "eq" : b.defaultSearch, k = 0; k < b.odata.length; k++)if (b.odata[k].oper === j) {
                                    s = b.operands[j] || "";
                                    break
                                }
                            ...
                            switch (a("td:eq(0)", v).attr("colindex", c).append(r), void
                                0 === g.clearSearch && (g.clearSearch = !0), g.clearSearch ? (n = b.resetTitle || "Clear Search Value", a("td:eq(2)", v).append("<a title='" + n + "' style='padding-right: 0.3em;padding-left: 0.3em;' class='clearsearchclass'>" + b.resetIcon + "</a>")) : a("td:eq(2)", v).hide(), this.surl && (g.dataUrl = this.surl), o = "", g.defaultValue && (o = a.isFunction(g.defaultValue) ? g.defaultValue.call(d) : g.defaultValue), p = a.jgrid.createEl.call(d, this.stype, g, o, !1, a.extend({}, a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), a(p).css({width: "100%"}).addClass(f.srInput), a("td:eq(1)", v).append(p), a(u).append(v), this.stype) {
                                case"select":
                    ...
                    if (d = e.p.savedRow.length >= 1 ? 0 : null, null !== d) {
                        ...
                        switch (k.edittype) {
                            ...
                            case"custom":
                                try {
                                    ...
                                    "e1" === q ? a.jgrid.info_dialog(f.errcap, "function 'custom_value' " + g.msg.nodefined, g.bClose, {styleUI: e.p.styleUI}) : "e2" === q ? a.jgrid.info_dialog(f.errcap, "function 'custom_value' " + g.msg.novalue, g.bClose, {styleUI: e.p.styleUI}) : a.jgrid.info_dialog(f.errcap, q.message, g.bClose, {styleUI: e.p.styleUI})
                                }
                        }
                        if (i !== e.p.savedRow[d].v) {
                            ...
                            if (t[0] === !0) {
                                ...
                                if (a.isFunction(e.p.beforeSubmitCell) && (u = e.p.beforeSubmitCell.call(e, e.rows[b].id, l, h, b, c), u || (u = {})), a("input.hasDatepicker", j).length > 0 && a("input.hasDatepicker", j).datepicker("hide"), "remote" === e.p.cellsubmit)if (e.p.cellurl) {
                                    ...
                                    y = e.p.prmNames, w = y.id, x = y.oper, v[w] = a.jgrid.stripPref(e.p.idPrefix, e.rows[b].id), v[x] = y.editoper, v = a.extend(u, v), a(e).jqGrid("progressBar", {
                                        ...
                                        error: function (d, h, i) {
                                            a("#lui_" + a.jgrid.jqID(e.p.id)).hide(), e.grid.hDiv.loading = !1, a(e).triggerHandler("jqGridErrorCell", [d, h, i]), a.isFunction(e.p.errorCell) ? (e.p.errorCell.call(e, d, h, i), a(e).jqGrid("restoreCell", b, c)) : (a.jgrid.info_dialog(f.errcap, d.status + " : " + d.statusText + "<br/>" + h, g.bClose, {styleUI: e.p.styleUI}), a(e).jqGrid("restoreCell", b, c))
                                        }
                                    }, a.jgrid.ajaxOptions, e.p.ajaxCellOptions || {}))
                                } else
                                    try {
                                        a.jgrid.info_dialog(f.errcap, f.nourl, g.bClose, {styleUI: e.p.styleUI}), a(e).jqGrid("restoreCell", b, c)
                                    } catch (q) {
                                    }
                                ...
                                try {
                                    window.setTimeout(function () {
                                        a.jgrid.info_dialog(f.errcap, h + " " + t[1], g.bClose, {styleUI: e.p.styleUI})
                ...
                p(a) {
                    ...
                    for (d
                        ...
                        if (null != a[d] && "object" == typeof
                                a[d] && p(a[d]), "level" === d && a.level > 0 && a.level === (0 === u ? a.level : u)) {
                            c = 0;
                            for (b
                                in
